import {getCategories,getPostsFromCategory,addPost, deletePost,deleteComment, updatePost, getPost,votePost,getCommentsFromPost,addComment,voteComment} from '../api/api'
